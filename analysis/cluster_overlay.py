...
def get_stat_significance(cluster_lineup_df, lineup_minute_min):
    ...
    unique_cluster_combos = set(clusters_lineups['clusters'].tolist())
    aggregated_cluster_combos = clusters_lineups['clusters','points_scored','points_allowed','MIN_TOT'].groupby('clusters').sum()
    aggregated_cluster_combos['net'] = aggregated_cluster_combos['points_scored'] - aggregated_cluster_combos['points_allowed']
    aggregated_cluster_combos['net_per_min'] = aggregated_cluster_combos['net_rating']/aggregated_cluster_combos['MIN_TOT']
